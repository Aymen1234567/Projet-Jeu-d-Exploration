...
{    
    ...
    {
        return j.getPower()>=getConsommationEnergetique();// à remplacer par la vérification que le crédit énergétique du joueur est suffisant pour utiliser l'outil
    }
