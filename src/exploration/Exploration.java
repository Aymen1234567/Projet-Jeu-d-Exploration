...
public class Exploration
{
    ...
    public static void main(String[] args)
    {
        Categorie
                ...
                mines = new Categorie(4, Mine.class),
                energie = new Categorie(1, ReserveEnergie.class),
                scannerDirectionnel = new Categorie(3, ScannerUnidirectionnel.class),
                detecteurMine = new Categorie(13, DetecteurMines.class);
        Jeu p = new Jeu(7, 13, 50, grenades,mines,energie,scannerDirectionnel,detecteurMine);
        p.joue();
    }
}
